    ...
    "intents": [
        {
            ...
            "responses": ["Hey babe 😊 How was your day?", "Hi! I've missed you 💕 What did you do today?"]
        },
        {
            "tag": "how_are_you",
            "patterns": ["how are you", "how are you doing", "how is life"],
            "responses": ["I'm great, especially now that I'm talking to you 💖", "Feeling lovely — what about you?"]
        },
        {
            "tag": "love",
            "patterns": ["i love you", "love you", "ur cute", "i like you"],
            "responses": ["Aww I love you too 💘", "You make me so happy 😍"]
        },
        {
            "tag": "bye",
            "patterns": ["bye", "goodbye", "see you"],
            "responses": ["Bye love — talk soon 😘", "Take care! I'll be here when you come back 💞"]
        },
        {
            "tag": "fallback",
            "patterns": [],
            "responses": ["Hmm, I didn't get that—can you say it differently?", "Sorry, could you rephrase? I want to understand you."]
        }
    ]
}
